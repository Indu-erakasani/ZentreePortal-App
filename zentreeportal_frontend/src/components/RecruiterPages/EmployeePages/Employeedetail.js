...
//   const F = ({ label, name, type = "text", select = false, onChangeFn = handle, value, children }) =>
//     select ? (
//       <TextField select fullWidth size="small" label={label} name={name} value={value ?? ""} onChange={onChangeFn}>
//         {children}
//       </TextField>
//     ) : (
//       <TextField fullWidth size="small" type={type} label={label} name={name}
//         value={value ?? ""} onChange={onChangeFn}
...
//           <F label="Blood Group" name="blood_group" value={form.blood_group} select>
//             <MenuItem value="">—</MenuItem>
//             {BLOOD_GROUPS.map(g => <MenuItem key={g} value={g}>{g}</MenuItem>)}
//           </F>
//         </Grid>
//         <Grid item xs={12} sm={4}><F label="Personal Email"      name="personal_email"     type="email" value={form.personal_email} /></Grid>
//         <Grid item xs={12} sm={4}><F label="Referred By"         name="referred_by"         value={form.referred_by} /></Grid>
//         <Grid item xs={12} sm={4}><F label="Probation End Date"  name="probation_end_date" type="date"  value={form.probation_end_date} /></Grid>
//       </Grid>
...
//       <Grid container spacing={2} mb={2}>
//         <Grid item xs={12} sm={6}><F label="Laptop Serial Number"    name="laptop_serial"      value={form.laptop_serial} /></Grid>
//         <Grid item xs={12} sm={6}><F label="Laptop Make / Model"     name="laptop_make_model"  value={form.laptop_make_model} /></Grid>
//         <Grid item xs={12} sm={6}><F label="Access Card Number"      name="access_card_number" value={form.access_card_number} /></Grid>
//         <Grid item xs={12} sm={6}><F label="Corporate Email Created" name="email_id_created"   value={form.email_id_created} /></Grid>
//       </Grid>
...
//       <Grid container spacing={2} mb={2}>
//         <Grid item xs={12} sm={6}><F label="Account Holder Name" name="account_holder_name" value={bd.account_holder_name} onChangeFn={handleBD} /></Grid>
//         <Grid item xs={12} sm={6}><F label="Account Number"      name="account_number"      value={bd.account_number}      onChangeFn={handleBD} /></Grid>
//         <Grid item xs={12} sm={4}><F label="IFSC Code"           name="ifsc_code"           value={bd.ifsc_code}           onChangeFn={handleBD} /></Grid>
//         <Grid item xs={12} sm={4}><F label="Bank Name"           name="bank_name"           value={bd.bank_name}           onChangeFn={handleBD} /></Grid>
//         <Grid item xs={12} sm={4}><F label="Branch"              name="branch"              value={bd.branch}              onChangeFn={handleBD} /></Grid>
//         <Grid item xs={12} sm={4}>
...
//       <Grid container spacing={2} mb={2}>
//         <Grid item xs={12} sm={6}><F label="Contact Name"     name="name"         value={ec.name}         onChangeFn={handleEC} /></Grid>
//         <Grid item xs={12} sm={6}><F label="Relationship"     name="relationship" value={ec.relationship} onChangeFn={handleEC} /></Grid>
//         <Grid item xs={12} sm={6}><F label="Phone"            name="phone"        value={ec.phone}        onChangeFn={handleEC} /></Grid>
//         <Grid item xs={12} sm={6}><F label="Email"            name="email"        type="email" value={ec.email} onChangeFn={handleEC} /></Grid>
//         <Grid item xs={12}>      <F label="Address"           name="address"      value={ec.address}      onChangeFn={handleEC} /></Grid>
//       </Grid>
...
//       <Grid container spacing={2} mb={2}>
//         <Grid item xs={12} sm={4}>
//           <F label="BGV Status" name="bgv_status" value={form.bgv_status} select>
//             {BGV_STATUSES.map(s => <MenuItem key={s} value={s}>{s}</MenuItem>)}
//           </F>
//         </Grid>
//         <Grid item xs={12} sm={4}><F label="BGV Agency"  name="bgv_agency"  value={form.bgv_agency} /></Grid>
//         <Grid item xs={12} sm={4}>
//           <Box mt={0.5}>
...
//           </Box>
//         </Grid>
//         <Grid item xs={12}><F label="BGV Remarks" name="bgv_remarks" value={form.bgv_remarks} /></Grid>
//       </Grid>
...
//     setSaving(true);
//     try {
//       await api.addDocument(employee._id, form);
//       onRefresh(); setAddOpen(false); setForm(EMPTY_DOC);
//     } finally { setSaving(false); }
//   };
...
//             Add documents to track their submission and verification status.
//           </Typography>
//         </Box>
//       ) : (
...
//               {docs.map((doc, i) => (
//                 <Box key={doc.idx} display="flex" alignItems="center" gap={2} px={2} py={1.5}
//                   sx={{ borderBottom: i < docs.length - 1 ? "1px solid #f1f5f9" : "none",
//                         "&:hover": { bgcolor: "#f8fafc" } }}>
//                   <Typography fontSize={13} fontWeight={500} flex={1}>{doc.name}</Typography>
...
//                   <Typography fontSize={11} color="text.disabled" sx={{ minWidth: 84 }}>
...
//       {/* ── Add Document Dialog ──────────────────────────────────────────── */}
//       <Dialog open={addOpen} onClose={() => { setAddOpen(false); setForm(EMPTY_DOC); }} maxWidth="sm" fullWidth>
//         <DialogTitle fontWeight={700} sx={{ borderBottom: "1px solid #e0e0e0" }}>Add Document</DialogTitle>
//         <DialogContent sx={{ pt: 2.5 }}>
//           <Grid container spacing={2}>
//             <Grid item xs={12} sm={6}>
//               <TextField select fullWidth size="small" label="Category" name="category"
//                 value={form.category} onChange={e => setForm(p => ({ ...p, category: e.target.value, name: "" }))}>
//                 {Object.keys(DOCUMENT_CATEGORIES).map(c => <MenuItem key={c} value={c}>{c}</MenuItem>)}
//               </TextField>
//             </Grid>
//             <Grid item xs={12} sm={6}>
//               <TextField select fullWidth size="small" label="Document Name" name="name"
...
//               <Grid item xs={12}>
//                 <TextField fullWidth size="small" label="Custom Document Name"
...
//             </Grid>
//             <Grid item xs={12}>
//               <TextField fullWidth size="small" label="Remarks (optional)" name="remarks"
//                 value={form.remarks} onChange={handle} />
//             </Grid>
//           </Grid>
//         </DialogContent>
//         <DialogActions sx={{ px: 3, pb: 2.5, borderTop: "1px solid #e0e0e0" }}>
//           <Button onClick={() => { setAddOpen(false); setForm(EMPTY_DOC); }}>Cancel</Button>
...
//   useEffect(() => {
//     if (open && employee) { setTab(0); loadOnboarding(); }
//   }, [open, employee?._id]);
...
//           sx={{ bgcolor: dc, "&:hover": { filter: "brightness(0.9)" } }}>
//           Edit Employee
//         </Button>
//       </DialogActions>
//     </Dialog>
