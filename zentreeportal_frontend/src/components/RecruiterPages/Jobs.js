...
//                     </TableCell>
//                     <TableCell sx={{ fontSize: 12 }}>{j.client_name}</TableCell>
//                     <TableCell>
...
//                     </TableCell>
//                     <TableCell sx={{ fontSize: 12 }}>{j.days_open ?? "—"}</TableCell>
//                     <TableCell>
...
//             {/* ── Two-column grid: Job Info + Requirements & Compensation ─── */}
//             <Grid container spacing={3}>
...
//               <Box mt={2.5} p={1.5} bgcolor="#f5f7fa" borderRadius={2}>
//                 <Typography fontSize={11} color="text.secondary" fontWeight={700}
...
//         {/* ── Action buttons: View Candidates | Track Progress | Edit Job ── */}
//         <DialogActions
//           sx={{
//             px: 3, py: 2.5,
...
//           }}
//         >
//           {/* View Candidates → /resumes?job=<id> */}
//           <Button
//             variant="outlined"
//             // startIcon={<PeopleAlt />}
//             onClick={() => {
//               setDetailOpen(false);
//               navigate(`/resumes?job=${selected._id}`);
//             }}
...
//           {/* Track Progress → /tracking?job=<id> */}
//           <Button
//             variant="outlined"
//             // startIcon={<TrackChanges />}
//             onClick={() => {
//               setDetailOpen(false);
//               navigate(`/tracking?job=${selected._id}`);
//             }}
//             sx={{ textTransform: "none", fontWeight: 600 }}
//           >
//             Track Progress
...
//                   {clients.map(c => (
//                     <MenuItem key={c._id} value={c._id}>{c.company_name}</MenuItem>
//                   ))}
//                 </TextField>
//               </Grid>
//               <Grid item xs={12} sm={6}>
...
//               </Grid>
//               <Grid item xs={6} sm={3}>
//                 <TextField select fullWidth size="small" label="Priority" name="priority"
//                   value={formData.priority} onChange={handleChange}>
//                   {PRIORITIES.map(p => <MenuItem key={p} value={p}>{p}</MenuItem>)}
//                 </TextField>
//               </Grid>
//               <Grid item xs={6} sm={3}>
//                 <TextField select fullWidth size="small" label="Status" name="status"
//                   value={formData.status} onChange={handleChange}>
//                   {STATUSES.map(s => <MenuItem key={s} value={s}>{s}</MenuItem>)}
//                 </TextField>
//               </Grid>
//               <Grid item xs={6} sm={3}>
//                 <TextField select fullWidth size="small" label="Job Type" name="job_type"
//                   value={formData.job_type} onChange={handleChange}>
//                   {JOB_TYPES.map(t => <MenuItem key={t} value={t}>{t}</MenuItem>)}
//                 </TextField>
//               </Grid>
//               <Grid item xs={6} sm={3}>
//                 <TextField select fullWidth size="small" label="Work Mode" name="work_mode"
...
//             <Grid container spacing={2} mb={2}>
//               <Grid item xs={6} sm={3}>
//                 <TextField fullWidth size="small" type="number" label="Openings" name="openings"
//                   value={formData.openings} onChange={handleChange} inputProps={{ min: 1 }} />
//               </Grid>
//               <Grid item xs={6} sm={3}>
//                 <TextField fullWidth size="small" type="number" label="Min Exp (yrs)" name="experience_min"
//                   value={formData.experience_min} onChange={handleChange} inputProps={{ min: 0 }} />
//               </Grid>
//               <Grid item xs={6} sm={3}>
//                 <TextField fullWidth size="small" type="number" label="Max Exp (yrs)" name="experience_max"
//                   value={formData.experience_max} onChange={handleChange} inputProps={{ min: 0 }} />
//               </Grid>
//               <Grid item xs={6} sm={3}>
//                 <TextField fullWidth size="small" type="date" label="Deadline"
//                   name="deadline" value={formData.deadline} onChange={handleChange}
//                   InputLabelProps={{ shrink: true }} />
//               </Grid>
//               <Grid item xs={12} sm={6}>
//                 <TextField fullWidth size="small" type="number" label="Min Salary (₹)" name="salary_min"
//                   value={formData.salary_min} onChange={handleChange} placeholder="e.g. 1200000" />
//               </Grid>
//               <Grid item xs={12} sm={6}>
//                 <TextField fullWidth size="small" type="number" label="Max Salary (₹)" name="salary_max"
//                   value={formData.salary_max} onChange={handleChange} placeholder="e.g. 1800000" />
//               </Grid>
//               <Grid item xs={12}>
//                 <TextField fullWidth size="small" label="Required Skills (comma-separated)"
...
//               <Grid item xs={12}>
//                 <TextField fullWidth multiline rows={4} size="small" label="Job Description"
//                   name="description" value={formData.description} onChange={handleChange}
//                   placeholder="Describe responsibilities, requirements and expectations…" />
//               </Grid>
//               <Grid item xs={12}>
//                 <TextField fullWidth multiline rows={2} size="small" label="Internal Notes"
        ...
        <form onSubmit={handleSave}>
          <DialogContent sx={{ pt: 3 }}>
            ...
            <Grid container spacing={2} mb={2}>
              ...
              {/* ── Show selected client name as a read-only confirmation ── */}
              {formData.client_name && (
                <Grid item xs={12} sm={6}>
                  <Box display="flex" alignItems="center" gap={1} height="100%"
                    sx={{ px: 1.5, py: 1, bgcolor: "#e3f2fd", borderRadius: 1.5,
                          border: "1px solid #90caf9" }}>
                    <Business sx={{ fontSize: 18, color: "#0277bd", flexShrink: 0 }} />
                    <Box>
                      <Typography fontSize={10} color="text.secondary" fontWeight={600}
                        textTransform="uppercase">Selected Client</Typography>
            ...
            <Grid container spacing={2} mb={2}>
              ...
              <Grid item xs={6} sm={3}>
                <TextField fullWidth size="small" type="number" label="Min Exp (yrs)"
                  name="experience_min" value={formData.experience_min} onChange={handleChange}
                  inputProps={{ min: 0 }} />
              </Grid>
              <Grid item xs={6} sm={3}>
                <TextField fullWidth size="small" type="number" label="Max Exp (yrs)"
              ...
              <Grid item xs={12} sm={6}>
                <TextField fullWidth size="small" type="number" label="Min Salary (₹)"
                  name="salary_min" value={formData.salary_min} onChange={handleChange}
                  placeholder="e.g. 1200000" />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField fullWidth size="small" type="number" label="Max Salary (₹)"
